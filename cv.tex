...
\textit{\textbf{Mixed Frequency Functional VARs for Nowcasting and Structural Analysis}}, with Gary Koop (Univeristy of Strathclyde), Stuart McIntyre (Univeristy of Strathclyde), James Mitchell (FRB Cleveand), and Ping Wu (Univeristy of Strathclyde).\\[.5em]
\textit{\textbf{Real-Time Forecasting with High-Frequency Seasonal Patterns}}, with Ana Galv\~ao (Bloomberg LP) and Ivan Petrella (Collegio Carlo Alberto, University of Warwick).
